...
create_lib -ref_lib $PDK_PATH/lib/ndm/saed32rvt_c.ndm IMG_LIB

read_verilog {./../DC/results/top.mapped.v} -library IMG_LIB -design top -top top
get_ports
...
#scenario4:
initialize_floorplan  -core_utilization 0.6 -core_offset {3 4} -coincident_boundary false
set_individual_pin_constraints -ports [get_ports B] -sides "1 2" -pin_spacing_distance 3
place_pins -self
...
#scenario9:
initialize_floorplan
create_placement_blockage -boundary {{3 3} {10 10}} -type hard
place_pins -self
create_placement -floorplan
remove_placement_blockages [get_placement_blockages PB_*]
